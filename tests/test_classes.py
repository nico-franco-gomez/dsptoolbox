...
class TestFilterBankClass:
    ...
    def test_filtering(self):
        ...
        assert isinstance(s_, dsp.MultiBandSignal)
        ...
        assert isinstance(s_, dsp.Signal)
    ...
    def test_iterator(self):
        ...
        fb.add_filter(dsp.Filter("fir", config, self.fs // 2))
        for n in fb:
            assert isinstance(n, dsp.Filter)
...
class TestMultiBandSignal:
    ...
    def test_create_and_general_functionalities(self):
        ...
        assert isinstance(mbs, dsp.MultiBandSignal)
    ...
    def test_get_all_bands(self):
        ...
        assert isinstance(mbs_, dsp.Signal)
    ...
    def test_iterator(self):
        ...
        for n in mbs:
            assert isinstance(n, dsp.Signal)
